...
function FeaturedProducts() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70%] bg-linear-to-b from-gray-300 to-white mix-blend-multiply py-10">
  ...
  <div className="
      w-full max-w-5xl overflow-x-auto snap-x snap-mandatory scroll-smooth scrollbar-none
      bg-[url('../../assets/images/bg/bg-8.jpg')]  
      mix-blend-multiply
      bg-cover bg-no-repeat bg-center rounded-lg px-4
    "
  >
    <div className="flex">
      {products.map((product, i) => (
        ...
        >
          {/* Image Card */}
          <div className="
              w-72 h-80 md:w-80 md:h-96 lg:w-96 lg:h-[500px]
              rounded-lg
              bg-[url(../../assets/images/bg/bg-1.jpg)]
          ...
          {/* Description Card */}
          <div className="
              w-72 md:w-80 lg:w-96 p-4 text-center text-green-700 font-semibold
              rounded-2xl
